...
class Rejected_Article extends React.Component{
    ...
    update_state = ()=>{
        ...
        fetch(IP+"/api/v0/article/status?status=REJECTED", requestOptions)
        ...
        return <div className={"col-xs-12 zero_pad"}>
            ...
            <div className={"col-xs-12"}>
                <h1 className={"synth_title col-xs-10"} style={{color:"#002148"}}>
                    Les articles en Supprimés & rejetés
                </h1>
...
const Side_action = (props)=>{
    ...
    return   <div className={"col-xs-3 zero_pad side_article_validation"} >
        ...
        <div className={"col-xs-12"}>
            <input type={"button"} value={"REVALIDER"} className={"my_button_validate_article"} onClick={()=>{
                set_to_valid(true)
            }}/>
...
export default Rejected_Article