...
const Publication_holder =(props)=>{
        ...
        useEffect(()=>{
            ...
            fetch(IP+"/api/v0/publication/robots-data?type="+type+"&valide=false", requestOptions)
        ...
        return <div className={"col-xs-12 zero_pad"}>
                ...
                <h1 className={"synth_title col-xs-10"} style={{color:"#002148"}}>
                    Les Publications  Des robots en attente de validation
                </h1>
            ...
            <div className={"col-xs-12"}>
                {
                    data.map((i)=>{
                      return  <div className={"col-xs-12"} key={i.publicationId}>
                            <Publication_Youtube {...i} validation={true} type={type} update_int={()=>{
                                set_int(int+1)
                            }} />
                        </div>
                    })
