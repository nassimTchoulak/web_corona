...
const Robots_head = ()=>{
    return   <div className={"col-xs-12 zero_pad video_head_back"} >
        ...
        <div className={"col-xs-3 col-xs-offset-2"} >  <NavLink  to={"/moderateur/robots/valide"}  activeClassName={"video_case_active"} className={"video_case"}  >  les publications validées </NavLink> </div>
